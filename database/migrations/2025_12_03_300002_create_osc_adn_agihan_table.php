...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('osc_adn_agihan', function (Blueprint $table) {
            ...
            $table->text('agh_ulasan')->nullable()->comment('ULASAN DARI JBTN/BHGN/UNIT');
            ...
            $table->date('agh_tkhulasan')->nullable()->comment('TARIKH ULASAN DIBERI');
            $table->date('agh_idate')->nullable()->comment('TARIKH KEMASUKAN');
            $table->date('agh_udate')->nullable()->comment('TARIKH KEMASKINI');
            ...
            $table->timestamps();
            $table->unique(['agh_idpbt', 'agh_noaduan', 'agh_ptjpk'], 'adn_agihan_uk');
            $table->comment('AGIHAN ADUAN DAN ULASAN JABATAN/BHGN/UNIT');
        });
