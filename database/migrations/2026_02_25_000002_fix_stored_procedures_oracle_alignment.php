...
{
    /**
     * Re-create stored procedures to fix column references after Oracle-MySQL schema alignment.
     *
     * Fixes:
     * - sp_ins_translesen: trn_tambh → trn_tmbhkurng (correct source column in osc_mhn_transaksi)
     * - sp_ins_iklanlesen: add lan_nosiri to INSERT target columns (Oracle has this column)
     * - sp_ins_dokumenlesen: add doc_nosiri to INSERT target columns
     * - sp_ins_gambarlesen: add gbr_nosiri to INSERT target columns
     * - ALL: Explicitly set CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci for parameters to avoid 1267 mismatch
     * - sp_ins_induklesen: Add kmdh_idpbt to osc_da_kemudahan insert
     */
    ...
    /**
     * Reverse the migrations — restore original SPs from the base migration.
     */
