...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('osc_ind_iklanlesen', function (Blueprint $table) {
            ...
            $table->datetime('lan_tkhmula')->nullable()->comment('TARIKH MULA');
            $table->datetime('lan_tkhtmt')->nullable()->comment('TARIKH TAMAT');
            ...
            $table->datetime('lan_tkhbatal')->nullable()->comment('TARIKH BATAL');
