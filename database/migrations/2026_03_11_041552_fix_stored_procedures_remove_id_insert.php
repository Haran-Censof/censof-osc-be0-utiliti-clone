    ...
    public function up(): void
    {
        ...
        DB::unprepared("
            ...
            BEGIN
                ...
                (nom_idpbt, nom_akaun, nom_idplgnom1, nom_namanom1,
                ...
                SELECT
                    p_idpbt, p_noakaun, nom_idplgnom1, nom_namanom1,
                    nom_trkhtmt1, nom_trkhkpm1, nom_idplgnom2, nom_namanom2,
                    nom_trkhtmt2, nom_trkhkpm2, nom_idplgnom3, nom_namanom3,
                    nom_trkhtmt3, nom_trkhkpm3, nom_idplgnom4, nom_namanom4,
                    nom_trkhtmt4, nom_trkhkpm4, nom_idplgnom5, nom_namanom5,
        ...
        DB::unprepared("
            ...
            BEGIN
                ...
                (gbr_idpbt, gbr_akaun, gbr_imsiri, gbr_namafail,
                gbr_pathfile, gbr_nosiri, gbr_idate, gbr_udate, gbr_iuser,
                gbr_uuser)
                SELECT
                    p_idpbt, p_noakaun, gbr_imsiri, gbr_namafail,
        ...
        DB::unprepared("
            ...
            BEGIN
                ...
                (doc_idpbt, doc_akaun, doc_dcsiri, doc_dokumen, doc_catatan,
                doc_nosiri, doc_idate, doc_udate, doc_iuser, doc_uuser)
                SELECT
                    p_idpbt, p_noakaun, doc_dcsiri, doc_dokumen, doc_catatan,
                    p_nosiri, doc_idate, NOW(), doc_iuser, p_uuser
        ...
        DB::unprepared("
            DROP PROCEDURE IF EXISTS sp_ins_induklesen;
             ...
             BEGIN
                 ...
                 DECLARE v_id BIGINT;
                 DECLARE v_mhn_idpbt VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 DECLARE v_mhn_jenis VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 DECLARE v_mhn_idpelanggan VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 DECLARE v_mhn_namaperniagaan VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 DECLARE v_mhn_almtniaga1 VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 DECLARE v_mhn_almtniaga2 VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 DECLARE v_mhn_norujukan VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 ...
                 DECLARE v_mhn_notel VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 DECLARE v_mhn_msmula VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 DECLARE v_mhn_mstamat VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 DECLARE v_mhn_kodlokasi VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 DECLARE v_mhn_ptjpk VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 DECLARE v_mhn_xcoordinat decimal(11,8);
                 DECLARE v_mhn_ycoordinat decimal(11,8);
                 DECLARE v_mhn_idate DATE;
                 DECLARE v_mhn_iuser VARCHAR(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
                 ...
                 DECLARE cur1 CURSOR FOR
                     ...
                     WHERE a.mhn_idpbt = p_idpbt COLLATE utf8mb4_unicode_ci
                       AND a.mhn_nosiri = p_nosiri COLLATE utf8mb4_unicode_ci;
                 ...
                 read_loop: LOOP
                     ...
                     WHERE ind_idpbt = p_idpbt COLLATE utf8mb4_unicode_ci;

                     INSERT INTO osc_ind_induklesen
                      (ind_idpbt, ind_akaun, ind_idpelanggan, ind_nosiri,
                      ...
                      VALUES
                     ( v_mhn_idpbt, v_akaun, v_mhn_idpelanggan, p_nosiri,
                     ...
                     INSERT INTO osc_ind_lpekerja
                      (lpk_idpbt, lpk_akaun, lpk_melayu, lpk_cina,
                       lpk_india, lpk_lainlain, lpk_idate, lpk_udate,
                       lpk_iuser, lpk_uuser)
                     VALUES
                      ( p_idpbt, v_akaun, v_lpk_melayu, v_lpk_cina,
                       v_lpk_india, v_lpk_lainlain,
                       v_mhn_idate, NOW(), v_mhn_iuser, p_uuser);

                     INSERT INTO osc_da_kemudahan
                       (kmdh_idpbt, kmdh_idpelanggan, kmdh_alamatid, kmdh_modakaun, kmdh_noakaun, kmdh_stathitam,
                        kmdh_idate, kmdh_udate, kmdh_iuser, kmdh_uuser)
                     VALUES
                       ( p_idpbt, v_mhn_idpelanggan, 10, 'L', v_akaun, 'T',
                        v_mhn_idate, NOW(), v_mhn_iuser, p_uuser);
            ...
            DROP PROCEDURE IF EXISTS sp_ins_induklesen;
             ...
             BEGIN
                 ...
                 read_loop: LOOP
                     ...
                     INSERT INTO osc_da_kemudahan
                       (id, kmdh_idpbt, kmdh_idpelanggan, kmdh_alamatid, kmdh_modakaun, kmdh_noakaun, kmdh_stathitam,
                        kmdh_idate, kmdh_udate, kmdh_iuser, kmdh_uuser)
                     VALUES
                       ( p_id1, p_idpbt, v_mhn_idpelanggan, 10, 'L', v_akaun, 'T',
                        v_mhn_idate, NOW(), v_mhn_iuser, p_uuser);
