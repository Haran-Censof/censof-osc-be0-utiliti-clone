...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('osc_adn_gbraduan', function (Blueprint $table) {
            ...
            $table->date('img_idate')->nullable()->comment('TARIKH KEMASUKAN');
            $table->date('img_udate')->nullable()->comment('TARIKH KEMASKINI');
            ...
            $table->timestamps();
            $table->unique(['img_idpbt', 'img_noaduan', 'img_imgsiri'], 'adn_gbraduan_uk');
        });
    }
