...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('osc_pbh_permohonan', function (Blueprint $table) {
            ...
            $table->datetime('pbh_tkmohon')->nullable()->comment('TARIKH MOHON');
            $table->datetime('pbh_tarikhlulus')->nullable()->comment('TARKH LULUS');
            $table->string('pbh_statl', 1)->nullable()->comment('STATUS KELULUSAN PERMOHONAN');
            $table->datetime('pbh_tkmula')->nullable()->comment('TARIKH MULA');
            $table->datetime('pbh_tktamat')->nullable()->comment('TARIKH TAMAT');
            ...
            $table->datetime('pbh_idate')->nullable()->comment('TARIKH INPUT PERMOHONAN');
            $table->datetime('pbh_udate')->nullable()->comment('TARIKH KEMASKINI PERMOHONAN');
            ...
            $table->timestamps();
            $table->index(['pbh_idpbt', 'pbh_nosiri']);
            $table->index('pbh_noakaun');
        });
    }
