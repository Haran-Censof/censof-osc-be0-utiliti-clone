...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('osc_bil_tmphlesen', function (Blueprint $table) {
            ...
            $table->date('bl1_tkhbil')->nullable()->comment('TARIKH BIL');
            $table->date('bl1_tempoh')->nullable()->comment('TEMPOH BIL');
            $table->string('bl1_statf', 1)->nullable()->comment('STATUS BIL [N]-BARU [P]-CETAKAN SEMULA');
            $table->date('bl1_idate')->nullable()->comment('TARIKH KEMASUKAN');
            $table->date('bl1_udate')->nullable()->comment('TARIKH KEMASKINI');
            ...
            $table->comment('MAKLUMAT BIL LESEN');
        });
    }
