...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('osc_cgr_cagaran', function (Blueprint $table) {
            ...
            $table->date('cag_tkhtrans')->nullable()->comment('TARIKH TRANSAKSI');
            ...
            $table->date('cag_idate')->nullable()->comment('TARIKH INPUT');
            $table->date('cag_udate')->nullable()->comment('TARIKH KEMASKINI');
            ...
            $table->timestamps();
            $table->comment('MAKLUMAT TRANSAKSI CAGARAN');
        });
    }
