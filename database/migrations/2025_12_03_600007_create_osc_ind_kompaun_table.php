...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('osc_ind_kompaun', function (Blueprint $table) {
            ...
            $table->date('kom_trikhmasa')->nullable()->comment('TARIKH MASA KESALAHAN');
            $table->date('kom_trikhnotis')->nullable()->comment('TARIKH NOTIS');
            $table->date('kom_trikhmhkmh')->nullable()->comment('TARIKH MAHKAMAH');
            $table->date('kom_trikhbayar')->nullable()->comment('TARIKH BAYAR');
