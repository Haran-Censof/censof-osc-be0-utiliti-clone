...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('osc_ktp_transaksi', function (Blueprint $table) {
            ...
            $table->date('ktp_tkhmasa')->nullable()->comment('TARIKHMASA TRANSAKSI');
            ...
            $table->date('ktp_idate')->nullable()->comment('TARIKH KEMASUKAN');
            $table->date('ktp_udate')->nullable()->comment('TARIKH KEMASKINI');
            ...
            $table->timestamps();
            $table->unique(['ktp_idpbt', 'ktp_notransaksi', 'ktp_jebil', 'ktp_noakaun'], 'ktp_transaksi_uk');
            $table->comment('MAKLUMAT TRANSAKSI  KUTIPAN');
        });
    }
